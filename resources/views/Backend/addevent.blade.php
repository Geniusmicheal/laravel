...
@section('content')
    ...
    @endif
    <form  method="post" enctype="multipart/form-data" class="needs-validation {{ (Session::get('error') != NULL  || Session::get('errors') != NULL ?'was-validated':'') }}"  action="{{ isset($result)?route('staffEditevent',['id'=>$result->event_id] ) : route('staffaddevent') }}">
        {{ csrf_field() }} 
        <div class="card">
                        ...
                        <div class="step">
                            <div class="step__content">
                                <p class="step__number">
                                    <i class="fa fa-github-alt fa_size" ></i>
                                </p>
            ...
            <div class="card-body" >
                ...
                <div class="row panel ">
                    ...
                    <div class="col-sm-4 form-group">
                        <input type="number" class="form-control"  placeholder="Number of Tickets"  value="{{ isset($result)? $result->tickets:'' }}" name="tickets">
                        @if($errors->get('tickets')!= NULL)
                            <div class="invalid-feedback">{{ $errors->get('tickets')[0] }}</div>
                        @endif
                    </div>
                ...
                <div class="row panel movingOutFoward">
            ...
            <div class="card-footer">
                <div class="pull-right"> 
                    <button class="button previous" style="display:none;" type="button">Previous</button>
...
//<script>
    ...
    function showTab (movement) {
        ...
        if (currentTab >= panel.length)forms[0].submit();
    ...
    imgInput.addEventListener('change',function(){
        ...
        if (extension == "png" || extension == "jpeg" || extension == "jpg") {
            ...
            document.getElementsByClassName("card-body")[0].style.minHeight = panel.offsetHeight + error;
