...
@section('style')
    <style>
        ...
        .section-gap-full {padding: 60px 0 !important;}
    ...
    <?php foreach($content as $contents): ?>
        <div class="single-blog-post">
            <div class="post-details">
                <ul class="tags">      
                    <li>
                        <a href="{{ route('newstags',['tag'=>$contents->categorys->category]) }}">
                            {{ $contents->categorys->category }}
                        </a>
                    </li>
                    <li><a href="#">{{ $contents->locations->location }} </a></li>
                </ul>
                <a href="{{ route('readnews',['type'=>$contents->categorys->category,'id'=>$contents->slug]) }}">
